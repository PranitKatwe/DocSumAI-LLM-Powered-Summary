...
SUBSCRIPTION_NAME = "doc-process-subscription"
...
def summarize_text(text, summary_type, preferred_model="bart"):
    ...
    if summary_type == "short":
        ...
        max_length, min_length = 250, 150
    elif summary_type == "long":
        max_length, min_length = 550, 250
    else:
...
def start_subscriber():
    ...
    logging.info(f"Subscriber listening to {SUBSCRIPTION_NAME}...")

    try:
        streaming_pull_future.result()
    except Exception as e:
        logging.error(f"Subscriber error: {str(e)}")
